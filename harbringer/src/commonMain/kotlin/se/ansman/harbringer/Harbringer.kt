...
interface Harbringer {
    ...
    companion object {
         ...
         *   deleted.
         * @param maxDiskUsage The approximate max size of the storage in bytes. If this is exceeded, the oldest requests
         *   will be deleted. In-flight requests are not counted towards this limit, so more data can be stored temporarily.
         * @param maxAge The maximum age of the requests to store. If this is exceeded, the oldest requests will be deleted.
         ...
         * @param maxDiskUsage The approximate max size of the storage in bytes. If this is exceeded, the oldest requests
         *   will be deleted. In-flight requests are not counted towards this limit, so more data can be stored temporarily.
         * @param maxAge The maximum age of the requests, in milliseconds, to keep. Older requests will be deleted.
         * @param enabled If `true` (default), requests will be stored. If `false`, requests will not be stored.
         * @param scrubber A lambda that returns a [Scrubber] for the given [Request]. This can be used to redact sensitive data.
         * @see FileSystemHarbringerStorage
         * @see Scrubber
